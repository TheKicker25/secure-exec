...
describe('Phase 2 integration: subprocess commands', { timeout: 30000, skip: !existsSync(WASM_PATH) ? 'WASM binary not built' : undefined }, () => {
  let os: WasmOS;
...
describe('Phase 2 integration: coreutils commands', { timeout: 30000, skip: !existsSync(WASM_PATH) ? 'WASM binary not built' : undefined }, () => {
  let os: WasmOS;
