 ...
 */
export async function exists(directory: Directory, path: string): Promise<boolean> {
  try {
 ...
 */
export async function stat(directory: Directory, path: string): Promise<StatInfo> {
  const now = Date.now();
 ...
 * Rename/move a file
 */
export async function rename(directory: Directory, oldPath: string, newPath: string): Promise<void> {
 ...
 */
export async function readDirWithTypes(directory: Directory, path: string): Promise<DirEntry[]> {
