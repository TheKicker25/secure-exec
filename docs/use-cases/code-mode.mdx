...
<Card title="Example on GitHub" icon="github" href="https://github.com/anthropics/secure-exec/tree/main/examples/code-mode">
...
See the [full working example](https://github.com/anthropics/secure-exec/tree/main/examples/code-mode) for the complete implementation including the `SecureExecExecutor`.
...
Code Mode support in Secure Exec is early. Today you need to copy the [`SecureExecExecutor` adapter](https://github.com/anthropics/secure-exec/tree/main/examples/code-mode) from the example into your project. We're planning official first-party support.
